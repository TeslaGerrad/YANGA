      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.totalCard}>
          <View style={styles.totalCardHeader}>
            <IconSymbol name="banknote" size={32} color="#4CAF50" />
            <Text style={styles.totalLabel}>Total Earnings</Text>
          </View>
          <Text style={styles.totalAmount}>
            KES {currentEarnings.toFixed(2)}
          </Text>
        ...
        <View style={styles.statsGrid}>
          <View style={styles.statCard}>
            ...
            <Text style={styles.statValue}>
              KES {(currentEarnings * 0.8).toFixed(0)}
            </Text>
          ...
          <View style={styles.statCard}>
            <View style={[styles.statIconContainer, styles.statIconOrange]}>
              <IconSymbol name="percent" size={24} color="#FF9800" />
            </View>
            <Text style={styles.statValue}>
              KES {(currentEarnings * 0.2).toFixed(0)}
            </Text>
                ...
                <View key={earning.rideId} style={styles.earningItem}>
                  ...
                  <View style={styles.earningRight}>
                    <Text style={styles.earningAmount}>
                      +KES {earning.netEarning.toFixed(2)}
                    </Text>
                    <Text style={styles.earningCommission}>
                      Commission: KES {earning.commission.toFixed(2)}
                    </Text>
                  </View>
                </View>
              );
          ...
          <View style={styles.breakdownCard}>
            <View style={styles.breakdownRow}>
              ...
              <Text style={styles.breakdownValue}>
                KES {(currentEarnings / 0.8).toFixed(2)}
              </Text>
            </View>
            ...
            <View style={styles.breakdownRow}>
              ...
              <Text style={[styles.breakdownValue, styles.breakdownNegative]}>
                -KES {(currentEarnings * 0.25).toFixed(2)}
              </Text>
            </View>
            <View style={styles.breakdownDivider} />
            <View style={styles.breakdownRow}>
